...
<!--导航条-->
<div class="width100" style="height: 45px;background: #673ab7;margin-top: 15px;position: relative;z-index: 100;">
    <!--中间的部分-->
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        <!--列表导航-->
        <div class="left_yh Selected" style="width: 230px;height: 45px;background: #673ab7;" id="hiddenShow">
            <!--头部的图标-->
            <img src="${ctx}/resource/user/images/cd.png" class="left_yh" style="margin-left: 24px;" alt="">
            <span class="block_yh left_yh fff" style="height: 45px;line-height: 44px;margin-left: 10px; background: #673ab7;">所有商品分类</span>
            <!--导航展开部分-->
            <div class="downSlide" style = "background: #673ab7;">
...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div class="example2" style="width: 1200px;height: 290px;overflow: hidden;margin-left: 230px;">
        <ul>
...
<%--            <li><img src="${ctx}/resource/images/d.webp" alt=""></li>--%>
    ...
    <script>
        $(function () {
            $(".example2").luara({width:"966",height:"290",interval:4500,selected:"seleted",deriction:"left"});
        });
    </script>
</div>
<!--折扣商品-->
